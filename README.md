...
```
cd existing_repo
git remote add origin https://gitlab.com/ljohar.1017/code-verifier-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ljohar.1017/code-verifier-backend/-/settings/integrations)
